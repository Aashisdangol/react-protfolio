...
export default function Background() {
  ...
  return (
    <div id="canvas_cyberlines" className="canvas canvas-cyberlines w-full h-full fixed -z-1">
      <svg
        id="cyberlines"
      ...
      >
        ...
        <g className="lights">
          <path
            ...
            transform="matrix(1,0,0,1,0,25.19999999999959)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-890.9999999999993)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,630.1800000000009)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-611.6039999999996)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-132.66947368421074)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,683.7480000000003)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-907.4699999999992)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,555.1200000000019)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,75.59999999999877)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-986.1119999999996)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,841.8239999999996)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,137.07692307692355)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-598.6079999999995)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-23.327999999999747)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-72.89999999999964)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,291.1679999999999)"
          />
          <path
            ...
            transform="matrix(1,0,0,1,0,-489.4559999999997)"
          />
        </g>
      </svg>
    </div>
